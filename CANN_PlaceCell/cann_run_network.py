...
def calculate_field(r, r_dir, rwu_l, rwu_r, rwu_d, rwu_u, r_masks, a, vgain_fac, h, n, npad, p):
    """ 
...
def update_weights(n_place, p_activity, r, w_pg):
    """ 
...
def get_singleneuron_activity(sna_eachlayer, r, itter, row_record, col_record):
    ...
    Args:
        sna_eachlayer (numpy.ndarray): A 3D array storing the activity data of neurons in each layer.
